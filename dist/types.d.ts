...
export type Exec = <R = Record<string, unknown>>(sql: string, params?: SqlParam[], options?: ExecOptions) => Promise<ExecResult<R>>;
/**
...
export interface ExpoSqliteDatabase {
    ...
    runAsync(sql: string, params?: SqlParam[]): Promise<{
        changes: number;
